...
syntax keyword systemverilogTodo TODO contained
syntax match systemverilogLineComment "//.*" contains=svTodo
syntax region systemverilogBlockComment start="/\*" end="\*/" contains=svTodo
syntax keyword systemverilogBoolean true false TRUE FALSE
syntax region systemverilogString start=+"+ skip=+\\"+ end=+"+
syntax keyword systemverilogType real realtime event reg wire integer logic bit time byte chandle genvar signed unsigned shortint shortreal string void int specparam
syntax keyword systemverilogDirection input output inout ref
syntax keyword systemverilogStorageClass parameter localparam virtual var protected rand const static automatic extern forkjoin export import
syntax match systemverilogInvPre "`\(\K\k*\)*\>"
syntax match systemverilogPreProc "`\(__FILE__\|__LINE__\|begin_keywords\|celldefine\|default_nettype\|end_keywords\|endcelldefine\|include\|line\|nounconnected_drive\|pragma\|resetall\|timescale\|unconnected_drive\|undef\|undefineall\)\>"
syntax match systemverilogPreCondit "`\(else\|elsif\|endif\|ifdef\|ifndef\)\>"
...
highlight! default link systemverilogUVMKeyword Keyword
highlight! default link systemverilogNumber Number
highlight! default link systemverilogTime Number
highlight! default link systemverilogStructure Structure
highlight! default link systemverilogTypedef Typedef
highlight! default link systemverilogSystemFunction Function
highlight! default link systemverilogOperator Operator
highlight! default link systemverilogDelimiter Delimiter
highlight! default link systemverilogObjectFunctions Function

highlight! default link systemverilogFunction none
highlight! default link systemverilogIdentifier none
highlight! default link systemverilogCase none
highlight! default link systemverilogPreprocessor none
highlight! default link systemverilogSystemFunctionName none
highlight! default link systemverilogInvPre none
highlight! default link systemverilogInvSystemFunction none
